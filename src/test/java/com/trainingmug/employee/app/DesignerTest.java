...
public class DesignerTest {
    ...
    @Test
    @Order(1)
    @DisplayName("Test Designer class should be present in com.trainingmug.employee.app package")
    void testDesignerClassShouldBePresent() {
        assertDoesNotThrow(() -> {
            Class.forName("com.trainingmug.employee.app.Designer");
    ...
    public void testDesignerClassInheritance() {
        try {
            Class<?> designerClass = Class.forName("com.trainingmug.employee.app.Designer");

            Class<?> employeeClass = Class.forName("com.trainingmug.employee.app.Employee");
    ...
    public void testCalculateNetSalaryInDesigner() {
        ...
        String expectedOutput = "calculateNetSalary() - Designer Class" + System.lineSeparator();
    ...
    @Test
    @Order(8)
    @DisplayName("Test calculateNetSalaryAfterIncrement Method in Employee Class")
    public void testCalculateNetSalaryAfterIncrementInEmployee() {
        Employee employee = new Employee(1234L, "Jane Doe", "Senior Developer", 5000.0f, 300.0f, 150.0f, 100.0f, 10.0f);

        // Ensure Employee does not have this method
        try {
            employee.getClass().getMethod("calculateNetSalaryAfterIncrement");
            fail("Employee class should not have calculateNetSalaryAfterIncrement method");
        } catch (NoSuchMethodException e) {
            // Expected exception, Employee does not have this method
        }
    }
    ...
    public void testCalculateNetSalaryAfterIncrementInDesigner() {
        ...
        String expectedOutput = "calculateNetSalaryAfterIncrement() - Designer Class" + System.lineSeparator();
        String actualOutput = outContent.toString();
